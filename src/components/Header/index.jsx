...
import { RiAlignJustify, RiSearchLine, RiCloseLine, RiDraftLine, RiAddLine, RiHeartFill } from 'react-icons/ri'
        ...
        <Container>
            <menu>
                ...
                <div className='desktop'>
                    ...
                    <Link to='/' onClick={signOut}> <FiLogOut size={24}/></Link>
