...
export function Payment() {
    ...
    async function handleFinishPayment() {
        if (cart.length < 1) {
            navigate(-1)
            return alert('Seu carrinho está vazio. Adicione um pedido!')
        }
    ...
    return (
        <Container>
...

            {
                ...
                <Content>
                    <div className='paymentMethod'>
                        <img src={clock} alt='Imagem de um relógio, aguardando pagamento' />
...

            {
                ...
                <Content>
                    <div className='paymentMethod'>
                        <img src={check} alt='Imagem de check, pagamento aprovado' />
...

            {
                ...
                <Content>
                    <div className='paymentMethod'>
                        <img src={forkKnife} alt='Imagem de um garfo e faca, pedido entregue!' />
                        <p>Pedido entregue!</p>
                    </div>
                </Content>
            }
